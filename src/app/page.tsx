  ...
  return (
    <RevealOnScroll delay={index * 0.1}>
      ...
      >
        <div className="relative aspect-[3/4] overflow-hidden rounded-2xl">
          {service.image && (
            <Image src={service.image} alt={service.name} fill className="object-cover md:opacity-60 md:group-hover:opacity-100 md:group-hover:scale-105 transition-all duration-500" />
          )}
          <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 via-zinc-900/50 to-transparent opacity-80 md:group-hover:opacity-0 transition-opacity duration-500" />
          
          <div className="absolute inset-0 bg-gradient-to-br from-pink-500/30 via-pink-500/10 to-transparent opacity-50 md:group-hover:opacity-0 transition-opacity duration-500" />
