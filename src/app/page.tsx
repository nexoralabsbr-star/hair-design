        ...
        <div className="relative aspect-[3/4] overflow-hidden rounded-2xl">
          ...
          <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-black/60 to-transparent">
            <div className="transform translate-y-0 transition-transform duration-500">
              <h3 className="text-[10px] font-medium text-white mb-0.5 tracking-wide">{service.name}</h3>
              <p className="text-[9px] text-zinc-400 line-clamp-1">{service.description}</p>
